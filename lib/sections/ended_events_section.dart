...
ScrollController endedEventsScrollController = new ScrollController();

class EndedEventsSection extends StatefulWidget {
  final Future<List<Data>> eventData;
  EndedEventsSection({@required this.eventData});

  @override
  _EndedEventsSectionState createState() => _EndedEventsSectionState();
}
...
class _EndedEventsSectionState extends State<EndedEventsSection> {
  ...
  void initState() {
    ...
    endedEventsScrollController.addListener(() async {
      if (endedEventsScrollController.position.pixels ==
              endedEventsScrollController.position.maxScrollExtent &&
          isLoaded.value &&
  ...
  @override
  void dispose() {
    endedEventsScrollController.dispose();
    super.dispose();
  }
        ...
        builder: (BuildContext context, bool isLoaded, Widget child) {
          ...
          if (postsController.eventsList.isEmpty) {
            ...
            return ListView.builder(
              padding: EdgeInsets.zero,
              controller: endedEventsScrollController,
              ...
              itemBuilder: (context, index) {
                ...
                return (postsController.eventsList[index].status == 'Ended')
                    ? InkWell(
                        child: Container(
