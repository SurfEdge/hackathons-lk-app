...
import 'package:hackathons_lk_app/services/upcomingEvents_PostsController.dart';
...
ScrollController upcomingEventsScrollController = new ScrollController();
...
class _UpcomingEventsSectionState extends State<UpcomingEventsSection> {
  final UpcomingEventsPostsController postsController =
      Get.put(UpcomingEventsPostsController());
  int _page = 1;
  bool isUpcomingAvailable = true;
  ...
  void initState() {
    ...
    upcomingEventsScrollController.addListener(() async {
      if (upcomingEventsScrollController.position.pixels ==
              upcomingEventsScrollController.position.maxScrollExtent &&
          isLoaded.value &&
          isUpcomingAvailable) {
  ...
  @override
  void dispose() {
    upcomingEventsScrollController.dispose();
    super.dispose();
  }
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                if ((index == postsController.eventsList.length - 1) &&
                    (postsController.eventsList[index].status != 'Ended')) {
                  isUpcomingAvailable = false;
                  return Center(
                    child: Container(
                ...
                return (postsController.eventsList[index].status == 'Upcoming')
                    ? InkWell(
                        child: Container(
